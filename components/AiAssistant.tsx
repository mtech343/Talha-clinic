...
const AiAssistant: React.FC<AiAssistantProps> = ({ isOpen, onClose }) => {
  const [messages, setMessages] = useState<{ role: 'user' | 'ai'; text: string }[]>([
    { role: 'ai', text: 'Welcome to Dr. Talha Dental Clinic. I am your AI assistant powered by Gemini 3 Pro. How can I help your smile today?' }
  ]);
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-end sm:items-center justify-center sm:justify-end p-4 sm:p-6 bg-black/20 backdrop-blur-sm">
      ...
      {/* Chat Window */}
      <div className="relative w-full sm:w-[450px] h-[600px] max-h-[85vh] bg-white rounded-[32px] shadow-[0_20px_60px_rgba(0,0,0,0.3)] flex flex-col overflow-hidden animate-fade-in">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-700 to-blue-900 p-6 text-white shrink-0">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="font-bold text-lg leading-none">Smart Dental AI</h3>
        ...
        <div className="p-4 bg-white border-t border-gray-100 shrink-0">
          ...
          <div className="flex justify-between items-center mt-3">
             <p className="text-[10px] text-gray-400">
               Visit Dr. Talha for professional diagnosis.
             </p>
             <button onClick={() => window.open('https://wa.me/923364705190', '_blank')} className="text-[10px] font-bold text-green-600">
               Book WhatsApp
             </button>
          </div>
        </div>
