        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a 
                href="https://www.facebook.com/p/Dr-Talha-Dental-Clinic-Jhelum-100090630822552/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors text-white"
                title="Facebook"
              >
              ...
              <a 
                href="https://www.instagram.com/dr_talha_liaquat" 
                target="_blank" 
                rel="noopener noreferrer"
